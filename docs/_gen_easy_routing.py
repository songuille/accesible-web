...
T = {
    "en": {
        ...
        "h_demo": "Demo video",
        "demo_p": "How to fix locked channels in Easy routing mode with the Easy Routing app.",
    ...
    "es": {
        ...
        "h_demo": "Vídeo demo",
        "demo_p": "Cómo solucionar el bug de canales bloqueados para el routing en modo Easy con la app Easy Routing.",
    ...
    "fr": {
        ...
        "demo_p": "Comment résoudre le bug des canaux bloqués en mode Easy routing avec l’app Easy Routing.",
    ...
    "de": {
        ...
        "h_demo": "Demo-Video",
        "demo_p": "So beheben Sie gesperrte Kanäle im Easy-Routing-Modus mit der Easy-Routing-App.",
    ...
    "ca": {
        ...
        "h_demo": "Vídeo demo",
        "demo_p": "Com solucionar el bug de canals bloquejats per al routing en mode Easy amb l’app Easy Routing.",
    ...
    "gl": {
        ...
        "h_demo": "Vídeo demo",
        "demo_p": "Como solucionar o bug de canles bloqueadas para o routing en modo Easy coa app Easy Routing.",
        "demo_title": "Vídeo demo de Easy Routing",
        "demo_open": "Abrir vídeo en Google Drive",
    ...
    "eu": {
        ...
        "h_demo": "Demo bideoa",
        "demo_p": "Nola konpondu kanal blokeatuen bug-a Easy routing moduan Easy Routing apparekin.",
